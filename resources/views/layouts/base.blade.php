...
<nav class="border-b border-gray-800">
    <div class="container  space-x4 font-sans bg-gray-100 max-w-full text-white p-5 table clear-both">
            ...
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                @auth
                    @if(Auth::user()->isAdministrator())
                        <a href="{{ url('admin/dashboard') }}" class="text-sm text-gray-700 underline">Administration</a>

                    @endif
                    <a href="{{ url('shop/dashboard') }}" class="text-sm text-gray-700 underline">My Book Dashboard</a>
    ...
    @if ($errors->any())
        ...
        <div class="flex bg-red-200 p-4">
            ...
            <div class="flex justify-between w-full pl-96">
